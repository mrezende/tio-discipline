...
\usepackage[square,sort,nonamebreak,comma]{natbib}  % citaÁ„o bibliogr·fica alpha (alpha-ime.bst)
\usepackage{setspace}                   % espaÁamento flexÌvel
...
\singlespacing   % espaÁamento simples
\bibliographystyle{alpha-ime}% citaÁ„o bibliogr·fica alpha
